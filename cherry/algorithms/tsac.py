...
def action_value_loss(q_old_pred, target_q_values, rewards, dones, gamma):
    """
    Arguments:
    ...
    * gamma: discount factor.
    ...
    assert rewards.size() == dones.size() == target_q_values.size(), msg
    q_target = rewards + (1.0 - dones) * gamma * target_q_values 
