...
dist:
	MKL_NUM_THREADS=$(THREAD_PER_PROC) NUMEXPR_NUM_THREADS=$(THREAD_PER_PROC) OMP_NUM_THREADS=$(THREAD_PER_PROC) python examples/distributed_atari/main.py main --num_steps=10000000 --num_workers=1
